...
from app.shared.responses.helpers import success, created
from app.shared.exceptions.custom import UnauthorizedException
from app.modules.auth.schemas import (
    RegisterRequest, RegisterResponse, LoginRequest, LoginResponse,
    RefreshResponse, ForgotPasswordRequest, ResetPasswordRequest, VerifyEmailRequest, UserResponse
)
...
async def login(response: Response, data: LoginRequest, db: AsyncSession = Depends(get_db)):
    ...
    # Set cookies with secure production flags
    response.set_cookie(
...
async def refresh(
    ...
    # Retrieve token from query or HTTPOnly cookie
